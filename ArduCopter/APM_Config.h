...
#define USERHOOK_FASTLOOP userhook_FastLoop();              // refresh SRV output ownership at 100Hz; carrier remains hardware PWM
#define USERHOOK_50HZLOOP userhook_50Hz();                  // RC9 single-step state machine at 50Hz
#endif
